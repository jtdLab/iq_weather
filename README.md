...
This project uses [fvm][fvm_link].
...
_\*Iq Weather works on iOS, Android, Web, and Windows._
...
First make sure [patrol_cli][patrol_cli_link] is installed.
...
[fvm_link]: https://fvm.app/documentation/getting-started
